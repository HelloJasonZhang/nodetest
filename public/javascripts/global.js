...
function showUserInfo(event) {
    ...
    if(thisUserName == undefined){
        thisUserName = $('#addUser fieldset input#inputUserName').val();
        console.log("thisUserName" + thisUserName);
    }
...
// Super basic validation - increase errorCount variable if any fields are blank
    ...
    if(errorCount === 0) {
        ...
        $.ajax({
            type: 'PUT',
            data: updateuser,
            url: '/users/updateuser/' + updateuser.userId,
            dataType: 'JSON'
            ...
            if (response.msg === '') {
                ...
                $('#userInfoId').text(updateuser._id);
                $('#userInfoName').text(updateuser.fullname);
                $('#userInfoAge').text(updateuser.age);
                $('#userInfoGender').text(updateuser.gender);
                $('#userInfoLocation').text(updateuser.location);
